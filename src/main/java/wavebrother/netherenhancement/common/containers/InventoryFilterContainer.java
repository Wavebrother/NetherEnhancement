package wavebrother.netherenhancement.common.containers;
...
import wavebrother.netherenhancement.common.item.ItemInventory;
...
{
	@ObjectHolder(Reference.MOD_ID + ":inventory_filter")
	public static ContainerType<InventoryFilterContainer> TYPE;

	public final Hand hand;
	public final ItemInventory inventory;
	public final List<ItemVoid.FilterSlot> filterSlots;
	public final QuartzTier tier;

	public InventoryFilterContainer(int id, PlayerInventory playerInventory, Hand h, QuartzTier tier)
	{
		super(TYPE, id);
		hand = h;
		inventory = ItemVoid.getInventory(playerInventory.player.getHeldItem(hand));
		...
		{
			ItemVoid.FilterSlot s = filterSlots.get(i);
	...
	{
		this(id, playerInventory, data.readBoolean() ? Hand.MAIN_HAND : Hand.OFF_HAND, QuartzTier.BASE);
	}
