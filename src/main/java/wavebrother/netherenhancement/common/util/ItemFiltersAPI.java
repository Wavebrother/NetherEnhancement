...
{
	public static final ResourceLocation FILTERS_ITEM_TAG = new ResourceLocation(Reference.MOD_ID, "filters");
	public static final ResourceLocation CHECK_NBT_ITEM_TAG = new ResourceLocation(Reference.MOD_ID, "check_nbt");
